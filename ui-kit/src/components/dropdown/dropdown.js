(function() {
    ...
    function build(document) {
        ...
        const dropdownPrototype = Object.create(HTMLElement.prototype)
      ...
      `
        ...
        dropdownPrototype.attachedCallback = function() {
            ...
            ddInput.onclick = function() {
                this.classList.add('focused')
                ddLabel.classList.add('focused')
                ddSelect.classList.remove('hidden')
            }

            ddInput.onkeypress = function(event) {
                if (event.keyCode === 32) {
                    ddSelect.classList.remove('hidden')
                }
            }
